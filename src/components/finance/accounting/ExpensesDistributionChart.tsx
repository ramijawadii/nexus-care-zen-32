...
const ExpensesDistributionChart: React.FC<ExpensesDistributionChartProps> = ({ data }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Nombre de Dépenses par Catégorie</CardTitle>
          <p className="text-sm text-muted-foreground">
            Total: {totalCount} dépenses
          </p>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={250}>
