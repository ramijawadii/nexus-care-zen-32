...
const InvoiceDistributionChart: React.FC<InvoiceDistributionChartProps> = ({ data }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Répartition des Factures par Montant</CardTitle>
