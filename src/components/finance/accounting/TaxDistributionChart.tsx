...
const TaxDistributionChart: React.FC<TaxDistributionChartProps> = ({ data }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Répartition Fiscale par Montant</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Types d'Impôts</CardTitle>
          <p className="text-sm text-muted-foreground">
            Total: {totalCount} déclarations
          </p>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={250}>
